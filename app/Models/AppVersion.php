...
class AppVersion extends Authenticatable implements MustVerifyEmail
{
    ...
    public function listTabData(){
        ...
        // $response = Cache::tags(AppVersion::table())->remember($cacheKey, $this->ttlCache, function() {
            return AppVersion::orderBY('app_version')->where('status',1)->pluck('app_version','app_version')->toArray();
        // });
    }
}
